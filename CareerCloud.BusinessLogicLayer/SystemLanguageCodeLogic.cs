    ...
    public class SystemLanguageCodeLogic
    {
        ...
        protected virtual void Verify(SystemLanguageCodePoco[] pocos)
        {
            ...
            foreach (SystemLanguageCodePoco poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(1000, $"LanguageID for SystemLanguageCode{poco.Name} is required"));
                }

                if (string.IsNullOrEmpty(poco.Name))
                {
                    exceptions.Add(new ValidationException(1001, $"Name for SystemLanguageCode{poco.LanguageID} is required"));
                }
